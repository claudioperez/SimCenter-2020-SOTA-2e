...
\paragraph{MatPower} \citeprgm{MatPower} \citep{zimmerman2011matpower} is a free toolbox available in MATLAB for conducting power flow analysis. It does not, however, have the capability to directly model natural hazard effects.
