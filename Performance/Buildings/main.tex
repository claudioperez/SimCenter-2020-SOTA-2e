...
\paragraph{Vulnerability and consequence functions} Vulnerability and consequence functions describe losses from a disaster as a function of its intensity and the experienced structural damage, respectively. Since vulnerabilit

Consequence functions describe the consequences of a building-level (e.g., HAZUS) or a component level (e.g., FEMA P-58) damage scenario.
