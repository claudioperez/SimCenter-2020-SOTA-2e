...
Risk is not static in time. As cities grow, new technologies are developed, population behaviors evolve, and the assets exposed as well the vulnerabilities change. Integrating risk dynamics models with housing recovery simulations can significantly improve the assessment of the benefits of housing recovery policies. This is another topic that can benefit from further research.\
