...
The most commonly used relationships to estimate CRR from SPT blow count are those proposed by \cite{youd2001liquefaction}, \cite{boulanger2014cpt}, and \cite{cetin2018spt}. 
The most commonly used relationships to estimate CRR from a $V_s$ profile are those developed by
\cite{andrus2000liquefaction} and \cite{kayen2013shearwave}.
