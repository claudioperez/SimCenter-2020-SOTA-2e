...
\begin{itemize}
    ...
    \item Physics-based GMMs describe the propagation of seismic waves from the location of the rupture to the surface at the investigated sites. They use a numerical model of the local geology (i.e. the upper part of the Ea 
\end{itemize}
