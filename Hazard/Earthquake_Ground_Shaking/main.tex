...
\begin{itemize}
    ...
    \item Stochastic ground motions are artificially generated accelerograms either from white noise that is modified to match target IMs \citep[ e.g.,][]{vanmarcke1997simqke, rezaeian2011simulation} or by modifying historical ground motion recordings \citep[ e.g.,][]{atkinson2010inelastic, seifried2016spectral}.
\end{itemize}
