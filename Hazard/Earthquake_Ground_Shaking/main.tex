...
\paragraph{smelt} The Stochastic, Modular, and Extensible Library for Time histories (\citeprgm{SMELT}) is a C++ library for stochastically generating time histories, including acceleration time histories to represent ground shaking.
