...
\printbibliography[segment=1,type=software,title={Earthquake - Ground Shaking}]
\printbibliography[segment=2,type=software,title={Earthquake - Surface Fault Rupture}]
\printbibliography[segment=3,type=software,title={Earthquake - Soil Liquefaction}]
