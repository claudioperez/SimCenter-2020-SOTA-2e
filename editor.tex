...
\segimport{editor/}{preface}
\segimport{editor/}{acknowledgement}

\setcounter{tocdepth}{1}
\tableofcontents

\segimport{editor/}{contriblist}
\segimport{editor/}{acronym}

\mainmatter%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\segimport{editor/}{introduction}

\segimport{Hazard/}{main}
